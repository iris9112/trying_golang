...
//biblioteca. Existen otros paquetes como search, match
package main
...
func másAlláDelHola() {
	...
	//La función aprendeMultiple devuelve	dos valores
	suma, producto := aprendeMultiple(x, y)
